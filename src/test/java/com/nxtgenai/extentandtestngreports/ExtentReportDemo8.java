...
public class ExtentReportDemo8 {
	
	static WebDriver driver;

	public static void main(String[] args) {

		// Attaching screen shot at log level in extent report
		...
		test1.log(Status.INFO,MediaEntityBuilder.createScreenCaptureFromPath(takeScreenShot("homePageScreenShot1")).build());
